...
# Jmeno se meni jednou za den, staci hodinovy poll.
...
["", "Jaroslava", "Patricie", "Radomír", "Prokop", "Cyril & Metoděj", "+ Jan Hus", "Bohuslava", "Nora", "Drahoslava", "Libuše / Amálie", "Olga", "Bořek", "Markéta", "Karolína", "Jindřich", "Luboš", "Martina", "Drahomíra", "Čeněk", "Ilja", "Vítězslav", "Magdaléna", "Libor", "Kristýna", "Jakub", "Anna", "Věroslav", "Viktor", "Marta", "Bořivoj", "Ignác"],
...
def setup_platform(
    ...
    """Set up the sensor platform from configuration.yaml (legacy)."""
    add_entities([CZSvatekSensor()], True)
...
async def async_setup_entry(
    ...
    """Set up the sensor platform from a config entry (added via UI)."""
    async_add_entities([CZSvatekSensor()], True)
...
class CZSvatekSensor(SensorEntity):
    ...
    _attr_unique_id = f"{DOMAIN}_svatek_dnes"
